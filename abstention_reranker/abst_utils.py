...
class AbstentionReranker:
    ...
    def get_scorer(self, relevance_scores_ref=None, metrics_ref=None):
        ...
        if self.method == 'max':
            ...
            self.scorer = get_scorer_logreg(self.relevance_scores_ref, self.metrics_ref, self.alpha, self.quantile_bad, self.quantile_good)
        
        elif self.method == 'mahalanobis':
            self.scorer = get_scorer_mah(self.relevance_scores_ref, self.metrics_ref, self.quantile_bad, self.quantile_good)
